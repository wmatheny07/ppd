...
CREATE TABLE IF NOT EXISTS espn.espn_athlete (
  athlete_id    BIGINT PRIMARY KEY,
  data          JSONB NOT NULL,
  updated_at    TIMESTAMPTZ NOT NULL DEFAULT now()
);

CREATE TABLE IF NOT EXISTS espn.espn_team_athlete (
  season_year   INT    NOT NULL,
  season_type   INT    NOT NULL,
  team_espn_id  INT    NOT NULL,
  athlete_id    BIGINT NOT NULL REFERENCES espn.espn_athlete(athlete_id),
  data          JSONB  NOT NULL,
  updated_at    TIMESTAMPTZ NOT NULL DEFAULT now(),
